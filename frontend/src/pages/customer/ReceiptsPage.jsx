...
import { 
    ...
    Search, Filter, ArrowRight, CheckCircle, X
} from 'lucide-react'
...
export default function ReceiptsPage() {
    ...
    const filteredReceipts = receipts.filter(receipt => {
        const matchesSearch = receipt.receiptId.toLowerCase().includes(searchQuery.toLowerCase()) ||
                          receipt.coolieName?.toLowerCase().includes(searchQuery.toLowerCase()) ||
...
========================================
Thank you for using CoolieSeva!
========================================
            `
            ...
            <div className="w-full md:ml-64 flex-1 p-4 sm:p-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-6 sm:mb-8">
                        <h1 className="text-2xl sm:text-3xl font-black text-white mb-2">My Receipts</h1>
                        <p className="text-slate-400 text-sm">
                            View and download all your trip receipts and payment history
                        </p>
                    </div>
                            ...
                            filteredReceipts.map(receipt => (
                                <div key={receipt.receiptId} className="card p-4 sm:p-6 hover:shadow-lg transition-shadow">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                                        <div>
                                            <p className="text-slate-400 text-xs mb-1">Coolie</p>
                                            <p className="text-white text-sm font-medium">{receipt.coolieName}</p>
                                        </div>
                                        <div>
                    ...
                    <div className="card w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="text-center mb-6 p-4 bg-slate-800/50 rounded-lg">
                                <h2 className="text-2xl font-bold text-blue-400 mb-2">COOLIESEVA</h2>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-3 pl-4 border-l-2 border-slate-700">
                                        <div className="flex justify-between py-2">
                                            ...
                                            <span className="text-white font-medium">{selectedReceipt.coolieName}</span>
                                        </div>
                                        <div className="flex justify-between py-2">
